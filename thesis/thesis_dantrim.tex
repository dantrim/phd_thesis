...
\newcommand{\SUtwoXone}{\ensuremath{\mathcal{SU}(2)_{L}\times\mathcal{U}(1)_{Y}}\xspace}
\newcommand{\SML}{\ensuremath{\mathcal{L}_{\text{SM}}}\xspace}
...
\newcommand{\fieldB}{$\mathcal{B}$}
\newcommand{\fieldW}{$\mathcal{W}$}
\newcommand{\fieldWone}{$\mathcal{W}_1$}
\newcommand{\fieldWtwo}{$\mathcal{W}_2$}
\newcommand{\fieldWthree}{$\mathcal{W}_3$}
\newcommand{\fieldWp}{$\mathcal{W}^+$}
\newcommand{\fieldWm}{$\mathcal{W}^-$}
\newcommand{\fieldWzero}{$\mathcal{W}^0$}
\newcommand{\fieldWpm}{$\mathcal{W}^{\pm}$}
\newcommand{\fieldZ}{$\mathcal{Z}$}
\newcommand{\fieldZzero}{$\mathcal{Z}^0$}
