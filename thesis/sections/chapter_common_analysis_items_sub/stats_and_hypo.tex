...
at which point a signal hypothesis may be considered excluded is quite sensitive to the uncertainty
...
Using this terminology, then, when no meaningful discrepancies (e.g. very low $p_0$-values) between the predicted background and observed event counts
...
The key takeaway from Ref.~\ref{AsymptoticFormula}, is that in the large $N$ limit, with $N$
