...
Each layer of an MM detector in the NSW is composed of $1023 \times 8$ parallel readout strips, giving
...
The two dimensional readout is achieved through the use of a stereo readout, in which
...
The combination of the stereo readout and high strip-multiplicities on each MM layer will
...
In the NSW, this TPC-like hit reconstruction is referred to as the micro-TPC (`$\mu$-TPC') reconstruction method.
The use of the timing information of each of the hits recorded by the readout strips
allows for the position \textit{above} the readout plane to be reconstructed, thereby
...
as illustrated in Figure~\ref{fig:nsw_mm_principle}.


\begin{figure}[!htb]
    \begin{center}
        \includegraphics[width=0.62\textwidth]{figures/nsw/nsw_mm_principle}
...
%\begin{figure}[!htb]
%    \begin{center}
%        \includegraphics[width=0.7\textwidth]{figures/nsw/mm_tpc_hit_loc}
%        \caption{
%        }
