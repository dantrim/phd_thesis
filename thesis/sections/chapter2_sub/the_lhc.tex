...
The chain is laid in a double-hexagonal structure, illustrated in Figure~\ref{fig:lhc_layout}. There are eight
...
from a Hydrogen source located near Linac 2.
...
to their final collision energies.
...
needed to get to the collision energies is not necessarily large.
...
around the central node of the RF oscillation.
...
The LHC RF cavities have an oscillation frequency of $400$\,MHz which which
...
This corresponds to a minimal time
...
allow for 2808 $25$\,ns-spaced bunches.
