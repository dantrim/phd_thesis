...
maintaining that there be at most 30\% statistical uncertainty on the benchmark MC samples
once selection for the associated region is applied.
This choice is made taking into account the three benchmark points, with the hope
of obtaining a continuous sensitivity throughout the three-body regime for samples
