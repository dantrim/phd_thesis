...
observables since most of the energy-momentum of the initial sparticle is transferred into the production of the final
state observables \textit{at threshold}.
...
This inefficiency reduces an analysis' sensitivity to these kinematic regimes, since the observable objects become experimentally
inaccessible.
...
\input{sections/chapter_search_stop2l_sub/results}
