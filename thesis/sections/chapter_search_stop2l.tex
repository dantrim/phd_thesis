...
%which means that they tend to have lower energies and momenta.
%% since most is transferred into the production of the final
%%state observables \textit{at or near their production threshold} (i.e. at r. 
