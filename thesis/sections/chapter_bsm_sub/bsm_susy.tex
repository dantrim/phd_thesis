...
These super-partners these are then grouped into the `super-multiplets'
...
The newly added SUSY particles are labelled with a $\sim$ to distinguish them.
...
light.
Given the exceedingly low cross-section for Higgs boson pair-production at the LHC, predicted by the SM,
