...
\begin{figure}[!htb]
    \begin{center}
        ...
        \caption{
            ...
            spin-zero Higgs boson to $W$-boson pairs, which decay via the parity-violating electroweak interaction
...
Generally, \mttwo assumes that the decay is symmetric, as in \ttbar, where there are two decay legs, each with
...
The minimization is carried out over all partitionings of the \ptmiss into the $\bm{q}_{\text{T}}^i$ and the $m_{\text{T}}$ are the typical
transverse masses,
\begin{align}
