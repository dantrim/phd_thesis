...
is defined by the projection of the particle's spin angular momentum, $\vec{\sigma}$, onto their momentum (direction of motion): $\vec{\sigma}\cdot \vec{p}$. If the massless fermion's spin
